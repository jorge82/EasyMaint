...
export default function SignUp(props) {
    ...
    return (
        <Container >
        <AlertDialog title={'User already exists!'} open={alertExist}></AlertDialog> 
      
        {  added && (<Alert severity="success">User added successfully!</Alert>)}
        {  edited && (<Alert severity="info">User updated successfully!</Alert>)}
